...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 d-print-none">
        ...
        <button onclick="window.print();" class="btn btn-primary shadow-sm">🖨️ Imprimer le contrat</button>
    </div>

    <!-- CORPS DU CONTRAT (Format Impression) -->
    <div class="card p-5 shadow-sm border-0 mb-4" id="printable-contract">
        ...
        <h4 class="fw-bold text-dark mb-3">2. Engagements</h4>
        <p class="text-muted small">Le présent contrat est régi par les lois en vigueur. Le locataire s'engage à maintenir les lieux en bon état de propreté et à s'acquitter de ses mensualités à terme échu.</p>
    ...
    <!-- TABLEAU DE SUIVI DES LOYERS (Masqué à l'impression) -->
    <div class="card p-4 shadow-sm border-0 d-print-none">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Suivi des Échéances & Paiements</h4>
            <span class="badge bg-secondary">Historique financier</span>
        </div>
...
<!-- STYLES CSS DÉDIÉS AUX RÈGLES D'IMPRESSION -->
<style>
.border-dashed {
