...
<head>
    <meta charset="UTF-8">
    <title>Locations[admin] de maisons</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/espaceadmin">Espace administration</a>
          </li>
...
@endif
    ...
    <form method="GET" action="{{ route('maisons.rechercheA') }}" class="d-flex">
        <input 
            type="text" 
            name="search" 
            class="form-control me-2" 
            placeholder="Rechercher une maison par le type de maison, prix et quartier."
